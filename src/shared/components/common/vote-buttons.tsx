    ...
    return (
      <div className="btn-group" role="group">
        ...
        {enableUpvotes(localSite, voteContentType) && (
          <button
            type="button"
            className={`btn btn-animate btn-light border-light-subtle ${
        ...
        {enableDownvotes(localSite, voteContentType) && (
          <button
            type="button"
            className={`btn btn-light border-light-subtle btn-animate ${
  ...
  return (
    <button
      className={classNames(
        "btn btn-animate btn-light border-light-subtle py-0",
...
function UpvotePct(props: UpvotePctProps) {
  ...
  return (
    thresholdCheck && (
      <button
        className={"btn btn-animate btn-light border-light-subtle py-0"}
