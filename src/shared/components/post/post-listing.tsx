...
export class PostListing extends Component<PostListingProps, PostListingState> {
  ...
  commentsLine(mobile = false) {
    ...
    return (
      <div className="post-listing__comments-line d-flex align-items-center justify-content-start flex-wrap text-muted">
        {this.commentsButton}
        {canShare() && (
          <button
            className="post-listing__btn post-listing__btn---share btn btn-sm btn-animate text-muted py-0"
        ...
        {!post.local && (
          <a
            className="post-listing__btn post-listing__btn--link btn btn-sm btn-animate text-muted py-0"
            title={i18n.t("link")}
            href={post.ap_id}
          >
    ...
    return (
      <>
        ...
        <div className="dropdown">
          <button
            className="post-listing__btn post-listing__btn--shoremore btn btn-sm btn-animate text-muted py-0 dropdown-toggle"
  ...
  get commentsButton() {
    ...
    return (
      <Link
        className="post-listing__btn post-listing__btn--comments btn btn-link text-muted ps-0 text-muted"
  ...
  get saveButton() {
    ...
    return (
      <button
        className="post-listing__btn post-listing__btn--save btn btn-sm btn-animate text-muted py-0"
  ...
  get crossPostButton() {
    return (
      <Link
        className="post-listing__btn post-listing__btn--xpost btn btn-sm btn-animate text-muted py-0"
        to={{
  ...
  get viewSourceButton() {
    return (
      <button
        className="post-listing__btn post-listing__btn--viewsrc btn btn-sm btn-animate text-muted py-0"
        ...
        <>
          ...
          {(amCommunityCreator(post_view.creator.id, this.props.moderators) ||
            ...
            (!this.state.showConfirmTransferCommunity ? (
              ...
              <>
                <button
                  className="post-listing__btn post-listing__btn--transfc-confirm d-inline-block me-1 btn btn-link btn-animate text-muted py-0"
                  aria-label={i18n.t("are_you_sure")}
                >
                  {i18n.t("are_you_sure")}
                </button>
                <button
                  className="post-listing__btn post-listing__btn--transfc-yes btn btn-link btn-animate text-muted py-0 d-inline-block me-1"
