...
export function RegistrationApplicationInput({ getSiteRes, onAnswerChange }: RegistrationApplicationInputProps) {
    const siteView = getSiteRes.site_view;
    const lastApplicationDurationSeconds =
        getSiteRes.last_application_duration_seconds;
    return siteView?.local_site.registration_mode === "require_application" && (
        <>
