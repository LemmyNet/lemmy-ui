...
export class SiteForm extends Component<SiteFormProps, SiteFormState> {
  ...
  handleCreateSiteSubmit(i: SiteForm, event: any) {
    ...
    i.setState({
      loading: true,
      siteForm: { ...i.state.siteForm, auth: auth().unwrap() },
    });
  ...
  handleSiteSidebarChange(val: string) {
    this.setState({ siteForm: { ...this.state.siteForm, sidebar: Some(val) } });
  }

  handleSiteLegalInfoChange(val: string) {
    this.setState({
      siteForm: { ...this.state.siteForm, legal_information: Some(val) },
    });
  }

  handleSiteApplicationQuestionChange(val: string) {
    this.setState({
      siteForm: { ...this.state.siteForm, application_question: Some(val) },
    });
  }

  handleSiteDescChange(i: SiteForm, event: any) {
    i.setState({
      siteForm: { ...i.state.siteForm, description: Some(event.target.value) },
    });
  }
  ...
  handleSiteEnableNsfwChange(i: SiteForm, event: any) {
    i.setState({
      siteForm: {
        ...i.state.siteForm,
        enable_nsfw: Some(event.target.checked),
      },
    });
  }
  ...
  handleSiteOpenRegistrationChange(i: SiteForm, event: any) {
    i.setState({
      siteForm: {
        ...i.state.siteForm,
        open_registration: Some(event.target.checked),
      },
    });
  }
  ...
  handleSiteCommunityCreationAdminOnly(i: SiteForm, event: any) {
    i.setState({
      siteForm: {
        ...i.state.siteForm,
        community_creation_admin_only: Some(event.target.checked),
      },
    });
  }
  ...
  handleSiteEnableDownvotesChange(i: SiteForm, event: any) {
    i.setState({
      siteForm: {
        ...i.state.siteForm,
        enable_downvotes: Some(event.target.checked),
      },
    });
  }
  ...
  handleSiteRequireApplication(i: SiteForm, event: any) {
    i.setState({
      siteForm: {
        ...i.state.siteForm,
        require_application: Some(event.target.checked),
      },
    });
  }
  ...
  handleSiteRequireEmailVerification(i: SiteForm, event: any) {
    i.setState({
      siteForm: {
        ...i.state.siteForm,
        require_email_verification: Some(event.target.checked),
      },
    });
  }
  ...
  handleSitePrivateInstance(i: SiteForm, event: any) {
    i.setState({
      siteForm: {
        ...i.state.siteForm,
        private_instance: Some(event.target.checked),
      },
    });
  }
  ...
  handleSiteDefaultTheme(i: SiteForm, event: any) {
    i.setState({
      siteForm: {
        ...i.state.siteForm,
        default_theme: Some(event.target.value),
      },
    });
  }
  ...
  handleIconUpload(url: string) {
    this.setState({ siteForm: { ...this.state.siteForm, icon: Some(url) } });
  }

  handleIconRemove() {
    this.setState({ siteForm: { ...this.state.siteForm, icon: Some("") } });
  }

  handleBannerUpload(url: string) {
    this.setState({ siteForm: { ...this.state.siteForm, banner: Some(url) } });
  }

  handleBannerRemove() {
    this.setState({ siteForm: { ...this.state.siteForm, banner: Some("") } });
  }
  ...
  handleDefaultPostListingTypeChange(val: ListingType) {
    this.setState({
      siteForm: {
        ...this.state.siteForm,
        default_post_listing_type: Some(ListingType[ListingType[val]]),
      },
    });
  }
}
